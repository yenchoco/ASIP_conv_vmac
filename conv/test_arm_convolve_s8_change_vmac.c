...
int8_t *arm_nn_mat_mult_kernel_s8_s16(const int8_t *input_a,    //filter array
                                      const int16_t *input_b,   //input array
                                      ...
                                      int8_t *out_0)
{
    ...
    const int32_t *bias = output_bias;  //basic_biases[1] = {6388};

    uint16_t row_count = output_ch / 2; //0
    alignas(32) const int8_t *ip_a0 = input_a;
    /* this loop over rows in A */
    while (row_count)
    {
        /* setup pointers for B */
        const int16_t *ip_b0 = input_b;
        const int16_t *ip_b1 = ip_b0 + aligned_num_col_a;   //ip_b0 + rhs_col
        // const int16_t *ip_b2 = ip_b1 + aligned_num_col_a;   //ip_b0 + rhs_col
        // const int16_t *ip_b3 = ip_b2 + aligned_num_col_a;   //ip_b0 + rhs_col

        /* align the second pointer for A */
        const int8_t *ip_a1 = ip_a0 + num_col_a;    //ip_a0 + rhs_col
    ...
    {
        /* setup pointers for B */
        alignas(32) const int16_t *ip_b0 = input_b;
        alignas(32) const int16_t *ip_b1 = ip_b0 + aligned_num_col_a;
                                    ...
                                    int8_t *output_data)
{
    ...
    int16_t *buffer_a = (int16_t *)ctx->buf;    //ptr to buffer
    ...
    #endif
                    im2col_buf_start_s16 += aligned_rhs_cols;   //move the ptr for the next iteration to put
